...
namespace FaceRecognition.Controller
{
   public class ParentNotify
   {
       ...
       public void SendMessage(string parentmail,DateTime currentTime) {
           ...
           try
           {
               MailMessage mail = new MailMessage("facerecognitionFYP@gmail.com", parentmail, "kindergarten Attendence", " Your child has arrived at the class on "+ currentTime);
               SmtpClient client = new SmtpClient("smtp.gmail.com");
               client.Port = 587;
               client.Credentials = new System.Net.NetworkCredential("facerecognitionFYP@gmail.com", "SUSHIapiit");
